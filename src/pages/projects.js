          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="Constructify (SASS Product)"
                summary="A feature-rich Construction App using React, Tailwind CSS, Context API, React Router and Recharts. It shows detail regarding almost all the real estate. You can easily have 360 Tour and CGI."
                img={proj1}
                link="https://constructify-xijd.vercel.app/"
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                ...
                title="Easy Parcel Website"
                img={proj2}
                link="https://easyparcel.com"
                github="https://github.com/nabeelnasir9"
              />
            </div>
            <div className="col-span-6 sm:col-span-12">
            ...
            <div className="col-span-6 sm:col-span-12">
              <Project
                type="Blog Website"
                img={proj7}
                title="Nabeel Nasir | Portfolio website"
                link="https://portfolio-web-git-main-nasirnabeel36-gmailcom.vercel.app/"
                github="https://github.com/nabeelnasir9"
              />
            </div>
          </div>
