    ...
    <div className="my-64">
      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Bachelor of Science in Electrical & Electronics Engineering"
            time="2018-2022"
            place="COMSATS University, (Lahore Campus)"
            info="Relevant courses included Data Structures and Algorithms, Computer Systems Engineering, and Artificial Intelligence."
          />

          <Details
            type="Diploma of Data Science"
            time="2023-2024"
            place="AtomCamp"
          ...
          <Details
            ...
            time="2018-Present"
            place="Upwork - Fiver"
            info="Custom Web Development, Mobile App Development, Data Science, Machine Learning Models, Advance Excel"
          />
        </ul>
      </div>
    </div>
