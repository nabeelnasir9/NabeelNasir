        ...
        <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
          ...
          <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
            ...
            <Details
              ...
              time="2022-2023"
              address="Lahore, Pakistan"
              work="Worked on a team responsible for developing Web & mobile app, including implementing new features such as product recommendations and user reviews, and optimizing the app's performance and reliability."
            />
            ...
            <Details
              ...
              company="COMSATS University (Lahore Campus)"
              companyLink="http://www.comsats.edu.pk/"
              time="Fall 2018"
              address="Lahore, Pakistan"
